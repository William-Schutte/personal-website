...
const p0 = new Project({ 
    name: "News Explorer Project", 
    ghLink: "https://github.com/William-Schutte/news-explorer-frontend",
    demoLink: "https://ws.news.students.nomoreparties.site/",
    description: [
        "News Explorer is a React application that fetches articles from a powerful NewsAPI and displays articles for the user. Once logged in, users can save articles to their profile.", 
        "This fully responsive SPA was built with Create-React-App, served via an EC2 machine on AWS. The backend is also on the same server at the API subdomain, running Node.js/Express.",
